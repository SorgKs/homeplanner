...
- **Периодическая сверка состояния**: для обнаружения расхождений без явных изменений используется механизм сверки SHA-256 хешей. Детали см. в `CACHE_STRATEGY_UPDATE_V1.md`.
