...
2. **TasksApiOffline** ⚠️
   ...
   - Расположение: `android/app/src/main/java/com/homeplanner/api/TasksApiOffline.kt`
   - Статус: Используется в `MainActivity`, требует миграции
...
- [ ] **Этап 3:** Обновление MainActivity
  - [ ] LocalApi создан
  - [ ] Все вызовы заменены
  - [ ] Явная синхронизация добавлена
  - [ ] Приложение работает

- [ ] **Этап 4:** Удаление TasksApiOffline
  - [ ] Проверка использования
  - [ ] Файл удалён
  - [ ] Тесты удалены/переписаны

- [ ] **Этап 5:** Обновление документации
  - [ ] OFFLINE_FIRST_ARCHITECTURE.md обновлён
  - [ ] Примеры обновлены
...
**Последнее обновление:** [дата будет добавлена после начала работы]  
**Ответственный:** [будет указан]
