 ...
 * Хранит полные данные задачи + метаданные конфликтов.
 */
    @Entity(
...
data class TaskCache(
    ...
    // Метаданные конфликтов больше не используются; поля сохранены только
    // для совместимости со старой схемой БД и могут быть удалены в будущих
    // миграциях.
