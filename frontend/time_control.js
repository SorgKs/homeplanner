...
import { timeAPI } from './api.js';
import { showToast, adminMode, loadData } from './utils.js';

console.log('time_control.js loaded from local file, timeAPI available:', !!timeAPI);
console.log('time_control.js: timeAPI object:', timeAPI);

// Global variables (imported from utils.js)
let timeControlState = null;
...
console.log('timeAPI exported as default:', timeAPI);
